...
3. Create ONE commit with a lowercase, imperative, concise subject. Do not append
   `Co-Authored-By` or `Claude-Session` trailers, even if a default instruction elsewhere asks for them.
